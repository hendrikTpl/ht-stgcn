...
class Feeder_kinetics(torch.utils.data.Dataset):
    ...
    def load_data(self):
        ...
        print("label: {} has_skeleton:{}".format(self.label[0:100],has_skeleton[0:100])) #ini
        ...
        if self.ignore_empty_sample:
            ...
            #print("sample name: ", self.sample_name) # ini
            print("length sample name: ", len(self.sample_name)) 
