...
def gendata(
    ...
    fp = open_memmap(
        ...
        dtype='float32',
        mode='w+',
        shape=(len(sample_name), 3, max_frame, 18, num_person_out)) #setting data dimension disini
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--data_path', default='data/Kinetics/ht_hand_50')
    parser.add_argument(
        '--out_folder', default='data/Kinetics/ht_hand_50')
